...
NDefines.NAI.MAX_UNITS_FACTOR_FRONT_ORDER = 3.5
NDefines.NAI.DESIRED_UNITS_FACTOR_FRONT_ORDER = 2.8
NDefines.NAI.MIN_UNITS_FACTOR_FRONT_ORDER = 2.2
NDefines.NAI.HOUR_BAD_COMBAT_REEVALUATE = 38
NDefines.NAI.AI_FRONT_MOVEMENT_FACTOR_FOR_READY = 0.1
NDefines.NAI.PLAN_VALUE_TO_EXECUTE = 0.25
